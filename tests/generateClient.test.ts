...
describe('generateClientCode', () => {
  ...
  describe('SheetORMClient class', () => {
    ...
    it('accepts a SheetsAdapter instance in the constructor', () => {
      const schema: SchemaMetadata = {
        models: {
          User: {
            name: 'User',
      ...
      const result = generateClientCode(schema);
      expect(result).toContain('constructor(adapter: SheetsAdapter)');
    });

    it('creates a Database internally with the embedded schema', () => {
      const schema: SchemaMetadata = {
        models: {
          User: {
            name: 'User',
      ...
      const result = generateClientCode(schema);
      expect(result).toContain('const db = new Database(_schema, adapter);');
    });
  });
  ...
  describe('exact output', () => {
    it('matches the expected full output for a basic schema', () => {
      ...
      expect(generateClientCode(schema))
        .toBe(`// Auto-generated by open-sheets-orm. Do not edit manually.
